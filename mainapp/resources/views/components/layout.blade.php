...
<html lang="en">
  ...
  <body>
      ...
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal">
          <a href="/" class="text-white">
            <img src="{{ asset('logo.png') }}" alt="pavillion quest Logo" style="height: 75px;">
          </a>
        </h4>
        
        @auth
        <div class="flex-row my-3 my-md-0">
          <a class="text-white mr-2 header-search-icon" title="Search" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-search"></i></a>
    ...
    <!-- footer begins -->
    <footer class="footer-bar border-top text-center small text-muted py-3">
        <p class="m-0 footer-content">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted"></a>All rights reserved.</p>
     </footer>
